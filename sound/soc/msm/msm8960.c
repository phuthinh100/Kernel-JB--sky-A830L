...
// EF47S 		MSM GPIO 35			HW_REVISION   5 
// EF45K 		MSM GPIO 35			HW_REVISION   5 
// EF46L 		MSM GPIO 35			HW_REVISION   4 
...
#if defined(T_EF47S) || defined(T_EF45K) || defined(T_STARQ)
    if(hw_rev < 5) {
        mbhc_cfg.gpio = 0;
		mbhc_cfg.gpio_irq = 0;
	}
#elif defined(T_EF46L) || defined(T_OSCAR)
	if(hw_rev < 4) {
		mbhc_cfg.gpio = 0;
		mbhc_cfg.gpio_irq = 0;
	}
